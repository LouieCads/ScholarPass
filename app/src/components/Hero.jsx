                ...
                <div className="flex flex-col justify-center">
                  ...
                  <ul className="space-y-2 sm:space-y-3 text-[#e0f2fe]">
                    <li className="flex items-center gap-2 sm:gap-3">
                      ...
                      <span className="text-sm sm:text-base">Pay for tuition and school fees</span>
                    </li>
                    <li className="flex items-center gap-2 sm:gap-3">
                      <div className="flex-shrink-0 w-5 h-5 sm:w-6 sm:h-6 bg-[#facc15] rounded-full flex items-center justify-center">
                        <span className="text-xs font-bold">✓</span>
                      </div>
                      <span className="text-sm sm:text-base">Buy books and school supplies</span>
                    </li>
                    <li className="flex items-center gap-2 sm:gap-3">
                      <div className="flex-shrink-0 w-5 h-5 sm:w-6 sm:h-6 bg-[#facc15] rounded-full flex items-center justify-center">
                        <span className="text-xs font-bold">✓</span>
                      </div>
                      <span className="text-sm sm:text-base">Access internet for online learning</span>
                    </li>
                    <li className="flex items-center gap-2 sm:gap-3">
                      <div className="flex-shrink-0 w-5 h-5 sm:w-6 sm:h-6 bg-[#facc15] rounded-full flex items-center justify-center">
                        <span className="text-xs font-bold">✓</span>
                      </div>
                      <span className="text-sm sm:text-base">Create opportunities for all students</span>
                    </li>
                  </ul>
                </div>
