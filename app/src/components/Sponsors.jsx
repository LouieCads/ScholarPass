...
export default function Sponsors() {
  ...
  return (
    <section id="sponsors" className="section bg-gradient-to-br from-[#004080] to-[#0054a6] text-white">
      <div className="container mx-auto px-3 sm:px-15 md:px-38 py-10 sm:py-16 md:py-20">
        <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-12 md:mb-16">
          <h2 className="mb-3 sm:mb-4 text-2xl sm:text-3xl md:text-4xl font-bold text-[#fbbf24]">Become a Sponsor</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 sm:p-6 md:p-8 border border-white/20">
            <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-[#fbbf24]">Why Sponsor Students?</h3>
            ...
            <ul className="space-y-4 mb-6 sm:mb-8">
              <li className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-sm sm:text-base text-[#fef3c7]">Make Real Impact</h4>
              ...
              <li className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-sm sm:text-base text-[#fef3c7]">Total Transparency</h4>
                  <p className="text-xs sm:text-sm md:text-base text-[#e0f0ff]">
              ...
              <li className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-sm sm:text-base text-[#fef3c7]">Community Recognition</h4>
                  <p className="text-xs sm:text-sm md:text-base text-[#e0f0ff]">
          ...
          <div className="bg-white rounded-2xl p-4 sm:p-6 md:p-8 text-[#0054a6]">
            <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 heading-gradient">Sponsor Options</h3>
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="border border-[#e0f0ff] rounded-xl p-4 sm:p-6 hover:shadow-md transition-all">
                ...
                <Button variant="default" onClick={() => setIsDialogOpen(true)} size="sm" className="w-full sm:w-auto">
                  Donate Now
                </Button>
              </div>
